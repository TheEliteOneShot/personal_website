...
<template>
  <header class="header" id="header">
    ...
    <div class="header_img"><img src="/public/icon.png" />
    </div>
    <div>
      <UserActionMenuDropdown />
    </div>
  ...
  <div class="l-navbar" id="nav-bar">
    <nav class="nav">
      <div>
        <router-link class="nav_link" to="/"><i class='bx bx-book-bookmark nav_logo-icon'></i> <span
            class="nav_logo-name">Zachary Laney</span></router-link>
        <div class="nav_list">
          <router-link class="nav_link" to="/Welcome"><i class='bx bx-grid-alt nav_icon router-link-active'></i> <span
              class="nav_name">Welcome Page</span></router-link>
          <router-link class="nav_link" to="/authtest"><i class='bx bx-data nav_icon'></i> <span class="nav_name">Auth
              Test</span></router-link>
        </div>
      </div>
